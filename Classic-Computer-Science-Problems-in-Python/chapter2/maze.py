...
class Maze:
    def __init__(self, rows: int = 10, columns: int = 10, sparseess: float = 0.2,
        ...
        self._randomly_fill(rows, columns, sparseess)
...
if __name__ == "__main__":
    ...
    if solutionl is None:
        ...
        path1: List[MazeLocation] = node_to_path(solutionl)
        m.mark(path1)
        print(m)
        m.clear(path1)
